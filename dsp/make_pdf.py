#!/usr/bin/env python3
"""
Render compiled.json into a single printable PDF of all the DSP questions,
options and answers.
...
SOURCES = [
    ("compiled.json", "TE 454 Digital Signal Processing"),
]
OUT = "TE454-Digital-Signal-Processing-MCQs-with-answers.pdf"
TITLE = "TE 454 - Digital Signal Processing"
SUBTITLE = "124 Multiple-Choice Questions with Answers"
