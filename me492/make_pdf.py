#!/usr/bin/env python3
"""
Render compiled.json into a single printable PDF of all the ME 492 questions,
options and answers.
...
SOURCES = [
    ("compiled.json", "ME 492 Management & Entrepreneurship Development"),
]
OUT = "ME492-Entrepreneurship-Past-Questions-with-answers.pdf"
TITLE = "ME 492 - Management & Entrepreneurship Development"
SUBTITLE = "228 Past-Paper Multiple-Choice Questions with Answers"
